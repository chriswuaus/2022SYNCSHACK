  ...
  return (
    <div>
      ...
      <main className={styles.main}>
        <h1>Hi John!</h1>
        {degreePlans.map(
          (val, index) => <div style={{padding: 10}}>
                        <Degree
        ...
        <Button sx={{ m: 1, maxWidth: 200, background: "#86bd33" }} variant="contained" onClick={() => { setShowModal(true) }}>Add degree</Button>
        <div className={styles.modal + (showModal ? ' ' + styles['modal-show'] : '')}>
          <button className={styles['align-end'] + ' ' + styles['close-button']} onClick={() => setShowModal(false)}>
